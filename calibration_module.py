...
class CameraCalibration:
    def __init__(self, calib_path: str = 'calibration_img',h:int=7,w:int=9):
    ...
    def checkerboard(self,square_size: float = 0.03,scale_percent:int=50):
    ...
    def detect_and_project(self, model_path="yolov8s.pt", avg_person_height=1.7):
        from camera_module import HikvisionCamera
        cam = HikvisionCamera()
