...
model_path = "/home/ubuntu/Documents/programs/CV/heavy_equipment.pt"
...
class CameraFeed(QThread):
    ...
    def __init__(self, width=1280, height=720, img_queue = multiprocessing.Queue()):
        super().__init__()
        self.img_w = width
        self.img_h = height
        self.cam = None
...
#     def __init__(self, camera_index=0, img_queue=Queue):
#         super().__init__()
...
#                 try:
#                     self.img_queue.put(rgb_frame, block=False)
#                 except :
#                     self.img_queue.get()
#                     pass
#                     #print("Queue is full, need to get first")
